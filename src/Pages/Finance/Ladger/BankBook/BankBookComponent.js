...
import BankBookComponentReciept from "./BankBookComponentReciept";
import Spinner from 'react-bootstrap/Spinner'
const BankBookComponent = ({ account_type, page_name }) => {
...
export default BankBookComponent;