...
const Balance = () => {
      ...
      .then(function (response) {
        if (response.status === 200) {
          ...
          for (let index = 0; index < categories_all_data.length; index++) {
            let top_level_1 = "";
            if (
              categories_all_data[index].level === 1 &&
              categories_all_data[index].parent_id === 0
            ) {
              ...
              for (
                let index2 = 0;
                index2 < categories_all_data.length;
                index2++
              ) {
                if (
                  categories_all_data[index2].level === 2 &&
                  categories_all_data[index2].parent_id ===
                    categories_all_data[index].category_id
                ) {
                  ...
                  for (
                    let index3 = 0;
                    index3 < categories_all_data.length;
                    index3++
                  ) {
                    let filtralized_data_4 = [];
                    if (
                      categories_all_data[index3].level === 3 &&
                      categories_all_data[index3].parent_id ===
                        categories_all_data[index2].category_id
                    ) {
                      ...
                      for (
                        let index4 = 0;
                        index4 < categories_all_data.length;
                        index4++
                      ) {
                        if (
                          categories_all_data[index4].level === 4 &&
                          categories_all_data[index4].parent_id ===
                            categories_all_data[index3].category_id
                        ) {
                          ...
                          for (
                            let index5 = 0;
                            index5 < account_all_data.length;
                            index5++
                          ) {
                            if (
                              account_all_data[index5].parent_id ===
                              categories_all_data[index4].category_id
                            ) {
                              top_level_4 = { ...account_all_data[index5] };
                              calculated_current_debit.push(
                                top_level_4.current_debit
                              );
                              calculated_current_credit.push(
                                top_level_4.current_credit
                              );
                          ...
                          top_level_3 = {
                            ...
                            calculated_credit: calculated_current_credit.reduce(
                              (a, b) => a + b,
                              0
                            ),
                            calculated_debit: calculated_current_debit.reduce(
                              (a, b) => a + b,
                              0
                            ),
                            children: filtralized_data_6,
                          };
                          calculated_current_credit_1.push(
                            top_level_3.calculated_credit
                          );
                          calculated_current_debit_1.push(
                            top_level_3.calculated_debit
                          );
                      ...
                      top_level_2 = {
                        ...
                        calculated_credit: calculated_current_credit_1.reduce(
                          (a, b) => a + b,
                          0
                        ),
                        calculated_debit: calculated_current_debit_1.reduce(
                          (a, b) => a + b,
                          0
                        ),
                        ...categories_all_data[index3],
                      };
                      filtralized_data_3.push(top_level_2);
                      calculated_current_credit_2.push(
                        top_level_2.calculated_credit
                      );
                      calculated_current_debit_2.push(
                        top_level_2.calculated_debit
                      );
                    }
                  }
                  top_level_1 = {
                    children: filtralized_data_3,
                    calculated_credit: calculated_current_credit_2.reduce(
                      (a, b) => a + b,
                      0
                    ),
                    calculated_debit: calculated_current_debit_2.reduce(
                      (a, b) => a + b,
                      0
                    ),
                  ...
                  calculated_current_credit_3.push(
                    top_level_1.calculated_credit
                  );
              ...
              top_level_1 = {
                ...
                calculated_credit: calculated_current_credit_3.reduce(
                  (a, b) => a + b,
                  0
                ),
                calculated_debit: calculated_current_debit_3.reduce(
                  (a, b) => a + b,
                  0
                ),
  ...
  return (
    <>
      ...
      >
        <CustomInnerHeader moduleName="Balance Sheet" isShowSelector={true} />
      </div>
      <div
              ...
              <>
                <div className="x_panel px-0">
                  ...
                  <BalanceSheetReciept
                    ref={componentRef}
                    dateTo={dateTo}
                    reportDataAssets={reportDataAssets}
                    reportDataLiabilities={reportDataLiabilities}
