          ...
          >
            ...
            <Tab eventKey="profile" title="Assets" disabled>
              <div className="row" ref={ref}>
                <div className="displayPropertyForPrint col-md-12 col-12 text-center">
                      ...
                      {reportDataAssets.map((each_level_1) => {
                        return (
                          <>
                            ...
                            >
                              <div className="  col-md-6   col-6    font-size-12 pl-1   text-left  ">
                              ...
                              <div className="  col-md-6  col-6    font-size-12     text-center  my-1">
                                <div className="row">
                                  ...
                                  <div className="col-md-6 col-6">
                                    <div className="col-md-12 col-12  text-right">
                                      {Number(
                                        each_level_1.calculated_credit
                                      ).toFixed(2)}
                                    </div>
                                  </div>
                                </div>
                                    ...
                                    <div className="  col-md-6  col-6    font-size-12     text-center  my-1">
                                      <div className="row">
                                        ...
                                        <div className="col-md-6 col-6">
                                          <div className="col-md-12 col-12 text-right">
                                            {Number(
                                              each_level_2.calculated_credit
                                            ).toFixed(2)}
                                          </div>
                                        </div>
                                      </div>
                                  ...
                                  {each_level_2.children.map((each_level_3) => {
                                    return (
                                      <>
                                        ...
                                        >
                                          <div className="  col-md-6   col-6    font-size-12   pl-3  text-left  my-1">
                                          ...
                                          <div className="  col-md-6  col-6    font-size-12     text-center  my-1">
                                            <div className="row">
                                              ...
                                              <div className="col-md-6 col-6">
                                                <div className="col-md-12 col-12 text-right">
                                                  {Number(
                                                    each_level_3.calculated_credit
                                                  ).toFixed(2)}
                                                </div>
                                              </div>
                                            </div>
                                          ...
                                          (each_level_4) => {
                                            return (
                                              <>
                                                ...
                                                >
                                                  <div className="  col-md-6   col-6    font-size-12   pl-4  text-left  my-1">
                                                  ...
                                                  <div className="  col-md-6  col-6    font-size-12     text-center  my-1">
                                                    <div className="row">
                                                      ...
                                                      <div className="col-md-6 col-6">
                                                        <div className="col-md-12 col-12 text-right">
                                                          {Number(
                                                            each_level_4.calculated_credit
                                                          ).toFixed(2)}
                                                        </div>
                                                      </div>
                                                    </div>
                                                  ...
                                                  (each_level_5) => {
                                                    return (
                                                      <>
                                                        ...
                                                        >
                                                          <div className="  col-md-6   col-6   pl-5  font-size-12    text-left  my-1">
                                                            {
                      ...
                      return (
                        <>
                          <div
                            ...
                            style={{ backgroundColor: "#fd8b5a" }}
                          >
                            <div className="  col-md-6   col-6    font-size-12 pl-1   text-left  my-1">
                              {each_level_1.category_name}
                            </div>
                            <div className="  col-md-6  col-6    font-size-12     text-center  my-1">
                              <div className="row">
                            ...
                            return (
                              <>
                                <div
                                  ...
                                  style={{ backgroundColor: "#f7ab8b" }}
                                >
                                  <div className="  col-md-6   col-6    font-size-12  pl-2   text-left  my-1">
                                    {each_level_2.category_name}
                                  </div>
                                  <div className="  col-md-6  col-6    font-size-12     text-center  my-1">
                                    <div className="row">
                                  ...
                                  return (
                                    <>
                                      ...
                                      >
                                        ...
                                        <div className="  col-md-6  col-6    font-size-12     text-center  my-1">
                                          <div className="row">
                                            <div className="col-md-6 col-6  col-6"></div>
                                            <div className="col-md-6 col-6">
                                              <div className="col-md-12 col-12 text-right">
                                                {Number(
                                                  each_level_3.calculated_debit
                                                ).toFixed(2)}
                                              </div>
                                            </div>
                                          </div>
                                                    ...
                                                    <>
                                                      ...
                                                      >
                                                        ...
                                                        <div className="  col-md-6  col-6    font-size-12     text-center  my-1">
                                                          ...
                                                          <div className="row">
                                                            <div className="col-md-4 col-4">
                                                              <div className="col-md-6 col-6 text-right"></div>
                                                              <div className="col-md-6 col-6 px-0 text-left"></div>
                                                            </div>
                                                            <div className="col-md-4 col-4">
