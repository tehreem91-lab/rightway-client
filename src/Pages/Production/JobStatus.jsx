                                    ...
                                    ApiRes?.map((item, id) => {
                                        return <React.Fragment key={id}>
                                            <div className="row mx-1 row-1   reportTableBody bottom-border-2">
                                                ...
                                                <div className="col-md-2 text-right  col-2  font-size-12 bold-6   py-1 pt-1 right-border-2 left-border-2    ">
                                                    {id + 1}
                                                </div>
                                                ...
                                                <div className="col-md-2 col-2 text-right  font-size-12    py-1  right-border-2 pt-1    ">
                                                    ...
                                                    /></div>
                                                <div className="col-md-2 col-2 text-left  font-size-12    py-1  right-border-2 pt-1    "> {item.job_status.toUpperCase()}</div>
