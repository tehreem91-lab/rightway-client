...
const StockOpeningBalances = () => {
  ...
  const fetchData = async () => {
    var config = {
      method: "get",
      url: `${endPoint}api/OpeningBalane/GetStockSelector`,
      headers: {
  ...
  const fetchAllData = async (e) => {
    ...
    var config = {
      method: "get",
      url: `${endPoint}api/OpeningBalane/GetStockData?fiscal_year_id=1&account=${e.stock_value}`,
      headers: {
        Authorization: `Bearer ${
          JSON.parse(localStorage.getItem("access_token")).access_token
        }`,
        ...
        setAccountListCSV([
          ...core_data,
          {
            ...
            credit: response.data
              .map((e) => e.credit)
              .reduce((a, b) => a + b, 0),
            quantity_debit: response.data
              .map((e) => e.quantity_debit)
              .reduce((a, b) => a + b, 0),
  ...
  return (
    <>
      ...
      >
        <CustomInnerHeader
          moduleName="Manage Opening Balance"
          isShowSelector={true}
        />
      </div>
          ...
          <div className="x_content">
            <span className="section pl-3">
              <div className="row   pt-3">
                <div className="col-3">
                  <i className="fa fa-filter"></i>&nbsp;Select Stock
                </div>
            ...
            <div className="row">
              <div className="field item form-group col-md-12 col-sm-12">
                <label className="col-form-label col-md-2 col-sm-2 label-align">
                  Stock Category <span className="required">*</span>
                </label>
                  ...
                  <ul className="mr-3 nav navbar-right panel_toolbox d-flex justify-content-end">
                    <div className="form-group col-md-3">
                      <ReactToPrint
                        ...
                        trigger={() => {
                          return (
                            <button
                              className="btn btn-sm  borderRadiusRound"
                              title="Print"
                              style={{
                    ...
                    <div className="form-group col-md-3">
                      <button
                        ...
                        style={{ backgroundColor: "#003A4D", color: "white" }}
                        onClick={downloadPdf}
                        type="button"
                      >
...
export default StockOpeningBalances;
