  ...
  const searchItem = (e) => {
    ...
    var filteredData = allData.filter((obj) => {
      var data = Object.keys(obj.stock_account)
        .filter((key) =>
          obj.stock_account[key].toString().toLowerCase().includes(e)
        )
        .reduce((cur, key) => {
                  ...
                  <div className="row px-4">
                    <div className="col-md-6 col-sm-6">
                      ...
                      <div className="col-md-8">
                        ...
                        />
                        {!isValidateAllStates && stockvalue === "" && (
...
"
                  ...
                  <div className="row">
                    <div className="col-md-12 ">
                      <table className="table jambo_table bulk_action bulk_action ">
                        <thead>
                          <tr className="headings reportTableHead">
                            <th className="column-title" style={{ width: "4%" }}>Sr.</th>
                    ...
                    return (
                      <>
                        <tr className="even pointer">
                          <td>{index + 1}</td>
                          <td className="">
                            {item.stock_account.stock_account_label}
                          </td>
                          <td className="">
                            {item.stock_account.stock_account_code}{" "}
                          </td>
                          <td className="text-center">
                            {item.stock_account.stock_unit_name}{" "}
                          </td>
                          <td className="a-right a-right     text-center">
                            <i
                              ...
                              onClick={() =>
                                FetchDataforEdit(item.stock_info_id)
                              }
                            ></i>
