            ...
            <div className="x_panel px-0">
              <div className="x_title mt-2 ">
                ...
                <div className="col-md-4  text-right px-0">
                  {
                    RoleToBeSearch === "" || RoleToBeSearch === null || RoleToBeSearch === undefined ? <></> :
                                    ...
                                    <tr className="moduleBgColor">
                                      ...
                                      <td className="text-center">
                                        <input
                                          ...
                                          className="flat"
                                          checked={
                                            item.pages.every((eachpage) => {
                                              return eachpage.viewPermission === "true" ? true : false
                                            })}
                                          onClick={(e) => {
                                            let isChecked = e.target.checked
                                            const filteredModules = pagePermissionList.filter(
                                              (eachMod) => {
                                                return (
                                                  eachMod.module_id !== item.module_id);
                                              });
                                            const updatedPages = item.pages.map((eachPage) => {
                                              return {
                                                ...eachPage,
                                                viewPermission: isChecked ? "true" : "false"
                                              }
                                            })
                                            const updatedPagePermissionState = [...filteredModules, { ...item, pages: updatedPages }]
                                      ...
                                      <td className="text-center">
                                        <input
                                          ...
                                          checked={
                                            item.pages.every((eachpage) => {
                                              return eachpage.DelPermission === "true" ? true : false
                                            })}
                                          onClick={(e) => {
                                            let isChecked = e.target.checked
                                            const filteredModules = pagePermissionList.filter(
                                            ...
                                            const updatedPages = item.pages.map((eachPage) => {
                                              return {
                                                ...eachPage,
                                                DelPermission: isChecked ? "true" : "false"
                                              }
                                            })
                                            const updatedPagePermissionState = [...filteredModules, { ...item, pages: updatedPages }]
                                      ...
                                      <td className="text-center">
                                        <input
                                          ...
                                          checked={
                                            item.pages.every((eachpage) => {
                                              return eachpage.AddPermission === "true" ? true : false
                                            })}
                                          onClick={(e) => {
                                            let isChecked = e.target.checked
                                            const filteredModules = pagePermissionList.filter(
                                            ...
                                            const updatedPages = item.pages.map((eachPage) => {
                                              return {
                                                ...eachPage,
                                                AddPermission: isChecked ? "true" : "false"
                                              }
                                            })
                                            const updatedPagePermissionState = [...filteredModules, { ...item, pages: updatedPages }]
                                      ...
                                      <td className="text-center">
                                        <input
                                          ...
                                          checked={
                                            item.pages.every((eachpage) => {
                                              return eachpage.EditPermission === "true" ? true : false
                                            })}
                                          onClick={(e) => {
                                            let isChecked = e.target.checked
                                            const filteredModules = pagePermissionList.filter(
                                            ...
                                            const updatedPages = item.pages.map((eachPage) => {
                                              return {
                                                ...eachPage,
                                                EditPermission: isChecked ? "true" : "false"
                                              }
                                            })
                                            const updatedPagePermissionState = [...filteredModules, { ...item, pages: updatedPages }]
