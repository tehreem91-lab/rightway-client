...
const LoanPayementVoucher = () => {

    const ref = useRef();
    const voucherAbbr = "LPV"
    ...
    const PostData = () => {
        ...
        var data = JSON.stringify({
            ...
            "debit": 0,
            "credit": loanMainState.loanTotalAmount,
            ...
            "sub_account_entries":accountOptionValue?.children?.length===0?[]: subAccountValues.map((eachSubAcc) => {
                return {
                    "sub_ladger_chart_id": eachSubAcc.value,
                    "debit": 0,
                    "credit": eachSubAcc.amount
                }
            }),
        ...
        var config = {
            method: 'post',
            url: `${endPoint}/api/LoanVoucher/PostData`,
            headers: {
        ...
        axios(config)
            .then(function (response) {
                if (response.status === 200) {
                    toast.success("Loan Payement Voucher Added")
                    ...
                    isLoading ? <><Loader /> </> : <div className="x_panel">
                        <div className="x_content mt-3">
                            ...
                            <div className="row">
                                ...
                                <div className="field item form-group col-md-6 col-sm-6">
                                    <label className="col-form-label col-md-3 col-sm-3 label-align">Loan Status<span className="required">*</span></label>
                                    <div className="col-md-8 col-sm-8">
                                        <input
                                            disabled
                                            className={`${employeeOptionValue.previous_loan_status === 1 ? "text-danger" : ""} form-control`}
                                            data-validate-length-range={6}
                                            data-validate-words={2}
                                            name="last_voucher_"
                                            placeholder="Loading"
                                            value={employeeOptionValue.previous_loan_status === 1 ? "Already Taken" : "Currently Not"}
                                        />
                                    </div>
                                </div>
 ...
 */}
                            ...
                            <div className="row">
                                <div className="field item form-group col-md-6 col-sm-6">
                                    <label className="col-form-label col-md-3 col-sm-3 label-align">Deduction %     <span className="required">*</span></label>
                                    <div className="col-md-8 col-sm-8">
                                        <input
                                            disabled={Number(loanMainState.loanTotalAmount) === 0 ? true : false}
                                            className="form-control"
                                            data-validate-length-range={6}
                                            data-validate-words={2}
                                            name="Select Amount"
                                            value={loanMainState.deductionInPercentage}
                                            placeholder="Enter Deduction in Percentage Here "
                                            type="number"
                                            max="100"
                                            onChange={(e) => {
                                                setloanMainState({
                                                    ...loanMainState,
                                                    deductionInAmount: (Number(e.target.value) * Number(loanMainState.loanTotalAmount)) / 100,
                                                    deductionInPercentage: Number(e.target.value),
                                ...
                                <div className="field item form-group col-md-6 col-sm-6">
                                    <label className="col-form-label col-md-3 col-sm-3 label-align">Deduction Amount<span className="required">*</span></label>
                                    <div className="col-md-8 col-sm-8">
                                        <input
                                            disabled={Number(loanMainState.loanTotalAmount) === 0 ? true : false}
                                            ...
                                            data-validate-words={2}
                                            name="Select Amount"
                                            value={(loanMainState.deductionInAmount)}
                                            placeholder="Enter Deduction in Percentage Here "
                                            type="number"
                                            max={loanMainState.loanTotalAmount}
                                            onChange={(e) => {
                                                setloanMainState({
                                                    ...loanMainState,
                                                    deductionInAmount: Number(e.target.value),
                                                    deductionInPercentage: (Number(e.target.value) * 100) / loanMainState.loanTotalAmount,
                            ...
                            <div className="row">
                                ...
                                <div className="field item form-group col-md-6 col-sm-6">
                                    <label className="col-form-label col-md-3 col-sm-3 label-align">Deduction Start<span className="required">*</span></label>
                                    <div className="col-md-8 col-sm-8">
                                        <input type="month"
                                            id="bdaymonth"
                                            value={loanMainState.deductionStartingMonth}
                                            className="form-control form-control-sm customStyleForInput"
                                            name="bdaymonth"
                                            onChange={(e) => {
                                                console.log(e.target.value, dateToday, "lorem");
                                                setloanMainState({
                                                    ...loanMainState,
                                                    deductionStartingMonth: e.target.value,
                                                })
                                            }}
                                        ></input>
                                    </div>
...
export default LoanPayementVoucher;
