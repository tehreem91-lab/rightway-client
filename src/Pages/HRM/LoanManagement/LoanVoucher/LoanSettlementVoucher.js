...
const LoanSettlementVoucher = () => {

    const ref = useRef();
    const voucherAbbr = "LSV"
    ...
    return (
        <>
            ...
            >
                <span>&nbsp;Loan Settlement Voucher</span>
            </div>
            <div
                role="main"
                    ...
                    isLoading ? <><Loader /> </> : <div className="x_panel">
                        <div className="x_content mt-3">
                            <span className="section pl-4">
                                <i className="fa fa-edit"></i>&nbsp;Add/Edit Loan Settlement Voucher
                            </span>
                            ...
                            <div className="row">
                                ...
                                <div className="field item form-group col-md-6 col-sm-6">
                                    <label className="col-form-label col-md-3 col-sm-3 label-align">Loan Inv<span className="required">*</span></label>
                                    <div className="col-md-8 col-sm-8">

                                        <Select
                                            value={loanVocherValue}
                                            isSearchable={true}
                                            styles={customStyles}
                                            onChange={(e) => {
                                                setLoanVocherValue(e)
                                                console.log(e, "app");
                                            }}
                                            options={employeeOptionValue.previous_loan_details}
...
export default LoanSettlementVoucher;
